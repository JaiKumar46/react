...
import Uncomplete from './todo/Uncomplete'
...
const App2 = () => {
  ...
  return (
    <Router>
      <Nav/>
      <Routes>
        <Route path='/' element={<TodoList submit={handleSubmit} list={list} del={handleDelete} update={handleUpdate} checked={handleChecked} empty={isEmpty}  />}/>
